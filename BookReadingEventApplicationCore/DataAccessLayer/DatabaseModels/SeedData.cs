    ...
    public static class SeedData
    {
        public static void Initializer(IServiceProvider serviceProvider)
        {
            ...
            (
                            ...
                            new User { UserID = 7, FullName = "Laura Norman", Email = "laura@gmail.com", Password = "laura@" }
            );
            context.SaveChanges();

            context.Event.AddRange
            (
                 new Event { EventID = 1, Title = "Node Js", Date = System.DateTime.Parse("2020-08-31"), Location = "India", StartTime = "09:00", Type = "Public", DurationInHours = 1, Description = "", OtherDetails = "", InviteByEmail = "laura@gmail.com", UserID = 1 },
                ...
                new Event { EventID = 3, Title = "Level Up", Date = System.DateTime.Parse("2021-10-01"), Location = "New Delhi", StartTime = "08:00", Type = "Private", DurationInHours = 2, Description = "", OtherDetails = "", InviteByEmail = "carson@gmail.com,anmol.baroliya@nagarro.com", UserID = 2 },
                ...
                new Event { EventID = 6, Title = "The Doors Alive", Date = System.DateTime.Parse("2020-06-12"), Location = "New York", StartTime = "16:00", Type = "Private", DurationInHours = 3, Description = "", OtherDetails = "", InviteByEmail = "yanli@rediff.com", UserID = 8 },
                ...
                new Event { EventID = 8, Title = "Mental Health Conference", Date = System.DateTime.Parse("2019-05-07"), Location = "Delhi", StartTime = "13:00", Type = "Public", DurationInHours = 1, Description = "", OtherDetails = "", InviteByEmail = "anmol.baroliya@nagarro.com", UserID = 3 },
                ...
                new Event { EventID = 11, Title = "Learn Python", Date = System.DateTime.Parse("2020-06-17"), Location = "Mumbai", StartTime = "04:00", Type = "Public", DurationInHours = 1, Description = "", OtherDetails = "", InviteByEmail = "laura@gmail.com,anmol.baroliya@nagarro.com", UserID = 7 },
                ...
                new Event { EventID = 15, Title = "Memorial Show", Date = System.DateTime.Parse("2015-01-30"), Location = "Shahdara", StartTime = "21:00", Type = "Private", DurationInHours = 4, Description = "", OtherDetails = "", InviteByEmail = "arturo@yahoo.com,anmol.baroliya@nagarro.com", UserID = 3 }
